...
const refresh = () => {
    ...
    <button data-key="exercise" data-increment="10">+10m</button>
    <button data-key="exercise" data-increment="15">+15m</button>
    <button data-key="exercise" data-increment="20">+20m</button>
    ...
    <h2>Walking</h2>
    <progress-bar>${stats.walking.progress / stats.walking.target}</progress-bar>
